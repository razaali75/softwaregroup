...
//exit();	
	if ( $submit ) {
		...
		$valid_input['gallery_image1_link'] = $input['gallery_image1_link'];												
...
function wptuts_setting_gallery_image1_link() {
	$wptuts_options1 = get_option( 'theme_homepage_options' );
	?>
		<input type="text" id="gallery_image1_link" name="theme_homepage_options[gallery_image1_link]" value="<?php echo esc_url( $wptuts_options1['gallery_image1_link'] ); ?>" />
		<span class="description"><?php _e('Image 1 Title.', 'wptuts' ); ?></span>
	<?php } 
...
function wptuts_setting_gallery_image2_link() {
	$wptuts_options1 = get_option( 'theme_homepage_options' );
	?>
		<input type="text" id="gallery_image2_link" name="theme_homepage_options[gallery_image2_link]" value="<?php echo esc_url( $wptuts_options1['gallery_image2_link'] ); ?>" />
...
function wptuts_setting_gallery_image3_link() {
	$wptuts_options1 = get_option( 'theme_homepage_options' );
	?>
		<input type="text" id="gallery_image3_link" name="theme_homepage_options[gallery_image3_link]" value="<?php echo esc_url( $wptuts_options1['gallery_image3_link'] ); ?>" />
...
function wptuts_setting_gallery_image4_link() {
	$wptuts_options1 = get_option( 'theme_homepage_options' );
	?>
		<input type="text" id="gallery_image4_link" name="theme_homepage_options[gallery_image4_link]" value="<?php echo esc_url( $wptuts_options1['gallery_image4_link'] ); ?>" />
...
function wptuts_setting_gallery_image5_link() {
	$wptuts_options1 = get_option( 'theme_homepage_options' );
	?>
		<input type="text" id="gallery_image5_link" name="theme_homepage_options[gallery_image5_link]" value="<?php echo esc_url( $wptuts_options1['gallery_image5_link'] ); ?>" />
