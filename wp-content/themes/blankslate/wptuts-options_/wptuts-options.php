...
add_settings_field('wptuts_setting_slider_Field',  __( 'Select Slider ', 'wptuts' ), 'wptuts_setting_slider_Field', 'wptuts', 'wptuts_settings_header_slider');
...
function wptuts_setting_svideo_Ulink() {
	...
	?>
		...
		<span class="description"><?php _e('Only include the Video ID ex: http://www.youtube.com/embed/' . '<strong>' .'aMtCOTGNDdY' . '</strong>', 'wptuts' ); ?></span>
	<?php } 
